...
public class h14game extends Applet {
    private Label label = new Label("Hoeveel vierkanten(één, twee, drie)?");
    ...
    public void init() {
        setBackground(new Color(30, 152, 165));
    ...
    private void removeRects(Graphics g) {
        ...
        g.drawString("Computer heeft dit ingevoerd: " + Integer.toString(random), 750, 100);
